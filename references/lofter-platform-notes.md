# LOFTER Platform Notes

Use these notes for LOFTER-specific posting advice. Platform rules and monetization conditions can change; tell the user to verify current in-app terms before relying on revenue or eligibility details.
...
Treat tags as discovery and community signals, not only traffic tools.
...
Use collections for series, same-CP clusters, same universe, or recurring format projects.

Good collection names are short, searchable, and stable. For serials, keep a consistent summary and chapter numbering pattern.

## Timing And Interaction

Non-official creator experience from the X article suggests evenings and weekends may perform better, and that replies/long comments help build readership. Treat this as experience-based guidance, not a platform guarantee.
